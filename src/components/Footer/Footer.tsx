    ...
    <footer className="bg-black text-gray-400 font-sans text-xs py-20 w-full">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        <div className="mx-5">
          ...
          <ul>
            <li className="mb-2 flex items-center">
              ...
              <a
                href="https://www.instagram.com/bookverse.com/"
                target="_blank"
            ...
            <li className="mb-2 flex items-center">
              ...
              <a
                href="https://www.facebook.com/BookVerse.com/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <li className="mb-2 flex items-center">
              ...
              <a
                href="https://www.youtube.com/channel/Bookv.com"
                target="_blank"
                rel="noopener noreferrer"
                className="px-2 hover:text-red-600"
              >
        ...
        <div>
          ...
          <p>
            General:{" "}
            <a href="mailto:info@bookverse.co.za" className="text-orange-500">
              info@captivity.co.za
            </a>
          </p>
          <p>
            Website Queries:{" "}
            <a href="mailto:web@bookverse.co.za" className="text-orange-500">
              web@bookverse.co.za
            </a>
          </p>
          <div className="mt-4">
            <p className="font-bold">CAPE TOWN:</p>
            <p>Tel: +27 21- 516 3848</p>
          </div>
          <div className="mt-4">
      ...
      <div className="container mx-auto text-center mt-10">
        <Link href="https://bookverse.co.za/contact/">
          <button className="bg-transparent border-2 border-slate-400 text-white hover:bg-orange-700 hover:border-white-700 py-2 px-4">
            OUR OFFICES
          </button>
        </Link>
      </div>
